...
public class DeployJpaJunit implements Filter{
	private static Logger logger=LoggerFactory.getLogger(DeployJpaJunit.class);
	...
	public void process(FilterChain filterChain) throws Exception {
		...
		for(MyClass myClass:myClasses){
			...
			Global.FU.process("JpaJunit", filterChain.getRoot(), servicePath+"Test"+serviceI+".java");
